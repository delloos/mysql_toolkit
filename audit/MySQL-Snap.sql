...
-- BEGIN
	...
	-- TMP TABLE CREATION
	SELECT @data_dir := VARIABLE_VALUE FROM INFORMATION_SCHEMA.GLOBAL_VARIABLES WHERE VARIABLE_NAME = 'data_dir';
	SELECT @base_dir := VARIABLE_VALUE FROM INFORMATION_SCHEMA.GLOBAL_VARIABLES WHERE VARIABLE_NAME = 'base_dir';
	SELECT @slow_query_log := VARIABLE_VALUE FROM INFORMATION_SCHEMA.GLOBAL_VARIABLES WHERE VARIABLE_NAME = 'slow_query_log_file';
	...
	-- SET @load_data_enabled != select variable_value from INFORMATION_SCHEMA.GLOBAL_VARIABLES WHERE VARIABLE_NAME = 'local_infile';
	...
	*/
	...
	select '' as '<table>';
	select concat('<tr><td>',VARIABLE_NAME, '</td><td>') as '<tr><th>Item</th><th>', concat(case when VARIABLE_NAME IN ('UPTIME', 'UPTIME_SINCE_FLUSH_STATUS') then VARIABLE_VALUE/60/60 else VARIABLE_VALUE end,'</td></tr>') as 'Value</th></tr>' from INFORMATION_SCHEMA.GLOBAL_VARIABLES WHERE variable_name like '%VERSION%'
	UNION ALL
	select concat('<tr><td>',VARIABLE_NAME, '</td><td>') as '', concat(round(VARIABLE_VALUE/60/60,1),' H</td></tr>') as '' from INFORMATION_SCHEMA.GLOBAL_STATUS WHERE variable_name like 'UPTIME%';
	select '' as '</table>';
	...
	-- from information_schema.GLOBAL_variables where variable_name like '%log%' order by variable_name;
	-- select '' as '</table>';
	...
	select '' as '<table>';
	select concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
	from information_schema.GLOBAL_variables where (variable_value like '%/%' or variable_value like '%\%') or variable_name like '%dir%' order by variable_name;
	select '' as '</table>';
	...
	*/
	...
	-- select concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
	-- from information_schema.GLOBAL_variables where variable_value like '%/%' order by variable_name or variable_name like '%dir%';
	select '' as '</table>';
	...
	concat('<td>',variable_value / (select round(min(variable_value)/3600,2) from information_schema.global_status where 
		variable_name = 'uptime' or variable_name = 'uptime_since_flush_status'), ' </td></tr>') as '' from information_schema.GLOBAL_status where variable_name = 'opened_tables'
		union all 
	...
	concat('<td>',variable_value,'</td></tr>')
	from information_schema.GLOBAL_status where variable_name = 'opened_tables'
	union all
	select '<tr><td>Table open cache (unit)</td>',
	concat('<td>',variable_value,'</td></tr>')
	from information_schema.GLOBAL_variables where variable_name = 'table_open_cache'
	union all
	select '<tr><td>Table open cache (unit)</td>',
	concat('<td>',variable_value,'</td></tr>')
	from information_schema.GLOBAL_variables where variable_name = 'table_open_cache_instance'
	union all
	select '<tr><td>Table open cache misses </td>',
	concat('<td>',variable_value,'</td></tr>')
	from information_schema.GLOBAL_STATUS where variable_name = 'table_open_cache_misses'
	union all
	...
	select '' as '<table>';
	select '<tr><td>Average Ratio/h</td>' as '', 
	concat('<td>',round(variable_value / (select min(variable_value)/3600 from information_schema.global_status where 
		variable_name = 'uptime' or variable_name = 'uptime_since_flush_status'),2), ' </td></tr>') as '' from information_schema.GLOBAL_status where variable_name = 'created_tmp_tables'
		union all 
	select '<tr><td>Average Ratio on disk/h</td>' as '', 
	concat('<td>',round(variable_value / (select min(variable_value)/3600 from information_schema.global_status where 
		variable_name = 'uptime' or variable_name = 'uptime_since_flush_status'),2), ' </td></tr>') as '' from information_schema.GLOBAL_status where variable_name = 'created_tmp_disk_tables'
		union all 
	...
	concat('<td>',round(((select variable_value from INFORMATION_SCHEMA.GLOBAL_STATUS 
	where variable_name = 'created_tmp_disk_tables')/(select variable_value 
		from INFORMATION_SCHEMA.GLOBAL_STATUS where variable_name = 'created_tmp_tables'))*100,2),'%</td></tr>')
	union all
	select '<tr><td>max heap table size</td>',
	concat('<td>',variable_value/1024/1024,'Mo</td></tr>') from INFORMATION_SCHEMA.GLOBAL_VARIABLES where variable_name = 'max_heap_table_size'
	union all
	
	select '<tr><td>tmp table size</td>',
	concat('<td>',variable_value/1024/1024,'Mo</td></tr>') from INFORMATION_SCHEMA.GLOBAL_VARIABLES where variable_name = 'tmp_table_size'
	union all
	select '<tr><td>max tmp table</td>',
	concat('<td>',variable_value,'</td></tr>') from INFORMATION_SCHEMA.GLOBAL_VARIABLES where variable_name = 'max_tmp_tables';
	...
	*/
	...
	/*select @buffer_pool_total := variable_value as '' from information_schema.GLOBAL_status where variable_name = 'innodb_buffer_pool_pages_total';
	select @buffer_pool_free := variable_value as '' from information_schema.GLOBAL_status where variable_name = 'innodb_buffer_pool_pages_free';
	select @buffer_pool_dirty := variable_value as '' from information_schema.GLOBAL_status where variable_name = 'innodb_buffer_pool_pages_dirty'; 
	select @buffer_pool_data := variable_value as '' from information_schema.GLOBAL_status where variable_name = 'innodb_buffer_pool_pages_data';
	*/
	...
	from information_schema.GLOBAL_variables where ( variable_name like '%binlog%' or variable_name like '%log_bin%') and variable_name not like '%com%'
	UNION ALL
	select 
	concat('<tr><td>',VARIABLE_NAME) as '', 
	concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '' 
	from information_schema.GLOBAL_status where variable_name like '%binlog%' and variable_name not like '%com%';
	select '' as '</table>';
	...
	SELECT @innodb_buffer_pool_pages_free := VARIABLE_VALUE FROM INFORMATION_SCHEMA.GLOBAL_STATUS WHERE VARIABLE_NAME = 'innodb_buffer_pool_pages_free';
	SELECT @innodb_buffer_pool_pages_total := VARIABLE_VALUE FROM INFORMATION_SCHEMA.GLOBAL_STATUS WHERE VARIABLE_NAME = 'innodb_buffer_pool_pages_total';
	SELECT @innodb_buffer_pool_pages_misc := VARIABLE_VALUE FROM INFORMATION_SCHEMA.GLOBAL_STATUS WHERE VARIABLE_NAME = 'innodb_buffer_pool_pages_misc';
	SELECT @innodb_buffer_pool_pages_data := VARIABLE_VALUE FROM INFORMATION_SCHEMA.GLOBAL_STATUS WHERE VARIABLE_NAME = 'innodb_buffer_pool_pages_data';
	SELECT @innodb_buffer_pool_pages_dirty := VARIABLE_VALUE FROM INFORMATION_SCHEMA.GLOBAL_STATUS WHERE VARIABLE_NAME = 'innodb_buffer_pool_pages_dirty';
	SELECT @innodb_page_size := VARIABLE_VALUE FROM INFORMATION_SCHEMA.GLOBAL_STATUS WHERE VARIABLE_NAME = 'innodb_page_size';
	...
	concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
	concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
	from information_schema.GLOBAL_STATUS where variable_name like '%thread%'
	UNION ALL
	select 
	concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
	concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
	from information_schema.GLOBAL_VARIABLES where variable_name like '%thread%';
	select '' as '</table>';
	...
	concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
	concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
	from information_schema.GLOBAL_VARIABLES where variable_name = 'have_query_cache'
	UNION ALL
	select 
	concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
	concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
	from information_schema.GLOBAL_VARIABLES where variable_name = 'query_cache_type'
	UNION ALL
	select 
	concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
	concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
	from information_schema.GLOBAL_VARIABLES where variable_name = 'query_cache_min_res_unit'
	UNION ALL
	select 
	concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
	concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
	from information_schema.GLOBAL_VARIABLES where variable_name = 'query_cache_size'
	UNION ALL
	select 
	concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
	concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
	from information_schema.GLOBAL_VARIABLES where variable_name = 'query_cache_limit'
	UNION ALL
	select 
	concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
	concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
	...
	concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
	concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
	from information_schema.GLOBAL_STATUS where variable_name = 'qcache_free_blocks'
	UNION ALL
	select 
	concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
	concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
	from information_schema.GLOBAL_STATUS where variable_name = 'qcache_free_memory'
	UNION ALL
	select 
	concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
	concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
	...
	concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
	concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
	from information_schema.GLOBAL_STATUS where variable_name = 'qcache_queries_in_cache'
	UNION ALL
	select 
	concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
	concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
	from information_schema.GLOBAL_STATUS where variable_name = 'qcache_total_blocks';
	select '' as '</table>';
	...
	when variable_value >= 1024 then concat(variable_value/1024, ' Ko')
		...
		from information_schema.GLOBAL_VARIABLES where variable_name = 'innodb_log_buffer_size'
		UNION ALL
		select 
		concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
		concat('</td><td>',case  
	...
	when variable_value >= 1024 then concat(variable_value/1024, ' Ko')
		...
		from information_schema.GLOBAL_VARIABLES where variable_name ='innodb_log_file_size'
		UNION ALL
		select 
		concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
		concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
		from information_schema.GLOBAL_VARIABLES where variable_name ='innodb_log_files_in_group';
	...
	select 
		concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
		concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
		from information_schema.GLOBAL_VARIABLES where variable_name = 'innodb_stats_method'
		UNION ALL
		select 
		concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
		concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
		from information_schema.GLOBAL_VARIABLES where variable_name ='innodb_stats_on_metadata'
		UNION ALL
		select 
		concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
		concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
		from information_schema.GLOBAL_VARIABLES where variable_name ='innodb_stats_persistent'
		UNION ALL
		select 
		concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
		concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
		from information_schema.GLOBAL_VARIABLES where variable_name ='innodb_stats_persistent_sample_pages'
		UNION ALL
		select 
		concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
		concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
		from information_schema.GLOBAL_VARIABLES where variable_name ='innodb_stats_sample_pages'
		UNION ALL
		select 
		concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
		concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
		from information_schema.GLOBAL_VARIABLES where variable_name ='innodb_stats_transient_sample_pages';
	...
	select 
		concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
		concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
		from information_schema.GLOBAL_VARIABLES where variable_name = 'innodb_flush_method'
		UNION ALL
		select 
		concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
		concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
		from information_schema.GLOBAL_VARIABLES where variable_name ='innodb_read_io_threads'
		UNION ALL
		select 
		concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
		concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
		from information_schema.GLOBAL_VARIABLES where variable_name ='innodb_write_io_threads'
		UNION ALL
		select 
		concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
		concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
		from information_schema.GLOBAL_VARIABLES where variable_name ='innodb_io_capacity'
		UNION ALL
		select 
		concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
		concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
		from information_schema.GLOBAL_VARIABLES where variable_name ='innodb_io_capacity_max'
		UNION ALL
		select 
		concat('<tr><td>',VARIABLE_NAME) as '<tr><td>Name</td>', 
		concat('</td><td>',VARIABLE_VALUE,'</td></tr>') as '<td>Value</td>' 
		from information_schema.GLOBAL_VARIABLES where variable_name ='innodb_use_native_io';
	...
	-- IF @version_full <= '579' THEN
		SELECT 
			...
			concat(host, '</td><td>') as '<th>host</th>',
			concat(password, '</td><td>') as '<th>Password</th>',
